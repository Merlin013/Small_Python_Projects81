...
def main():
    ...
    while True:  # main game loop
        ...
        # Handle whether the player won, lost or ties:
        if dealerValue > 21:
...
def getHandValue(cards):
    """Returns the value of the cards. Face cards are worth 10, aces are 11 or 1 (this function picks the most suitable
    ace value)."""
    value = 0
    numberOfAces = 0
