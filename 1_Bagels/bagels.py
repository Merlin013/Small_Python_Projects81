"""Bagels, by AL Sweigart al@investwithpython.com
...
def main():
    ...
    For example, if the secret number was 248 ad your guess was 843. the clues would be Fermi Pico'''.format(
        NUM_DIGITS))
...
def getSecretNum():
    """Returns a string made up of NUM_DIGITS unique and random digits."""
